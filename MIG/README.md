...
<img src="Figuras/1.png" width="100%" alt="MIG Output Options">
...
<img src="Figuras/2.png" width="100%" alt="Pin Compatible FPGAs">

### Passo 3: Seleção do Tipo de Memória
Selecionamos a tecnologia física da nossa RAM externa: **DDR3 SDRAM**.

<img src="Figuras/3.png" width="100%" alt="Memory Selection">
...
<img src="Figuras/4.png" width="100%" alt="Controller Options 1">
<img src="Figuras/4.1.png" width="100%" alt="Controller Options 2">
...
<img src="Figuras/5.png" width="100%" alt="AXI Parameters">
...
<img src="Figuras/6.png" width="100%" alt="Memory Options 1">
<img src="Figuras/6.1.png" width="100%" alt="Memory Options 2">
...
<img src="Figuras/7.png" width="100%" alt="FPGA Options 1">
<img src="Figuras/7.1.png" width="100%" alt="FPGA Options 2">

### Passo 8: Opções Estendidas da FPGA (Terminação Interna)
* **Internal Termination Impedance:** `50 Ohms`.

<img src="Figuras/8.png" width="100%" alt="Extended FPGA Options">
...
<img src="Figuras/9.png" width="100%" alt="IO Planning Options">
